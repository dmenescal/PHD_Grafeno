...
%
%   [YPRIME PARAMS RESNORM RESIDUAL JACOBIAN] = LORENTZFIT(X,Y) returns
%   YPRIME(X) values in addition to fit-parameters PARAMS = [P1 P2 P3 C].
%   The RESNORM, RESIDUAL, and JACOBIAN outputs from LSQCURVEFIT are also
%   returned.
%
...
%   v1.7 - 2020/06/15 - jrw
%       Added the Jacobian produced by LSQCURVEFIT to the output list
...
switch lower(nparams)
    case '1'
        ...
        [params,resnorm,residual,~,~,~,J] = lsqcurvefit(@lfun1,p0,x,y,lb,ub,options);
    ...
    case '1c'
        ...
        [params,resnorm,residual,~,~,~,J] = lsqcurvefit(@lfun1c,p0,x,y,lb,ub,options);
    ...
    case '2'
        ...
        [params,resnorm,residual,~,~,~,J] = lsqcurvefit(@lfun2,p0,x,y,lb,ub,options);
    ...
    case '2c'
        ...
        [params,resnorm,residual,~,~,~,J] = lsqcurvefit(@lfun2c,p0,x,y,lb,ub,options);
    ...
    case '3c'
        ...
        [params,resnorm,residual,~,~,~,J] = lsqcurvefit(@lfun3c,p0,x,y,lb,ub,options);
